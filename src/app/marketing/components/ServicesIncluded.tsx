...
export const ServicesIncluded: React.FC<ServicesIncludedProps> = ({ items, className = "" }) => {
  return (
    <div className={`flex flex-col items-center ${className}`}>
            ...
            <div
              ...
              style={{
                ...
                background: isHighlight
                  ? `linear-gradient(135deg, ${brand.primary}44, ${brand.secondary}33)`
      ...
      <div
        className="md:hidden flex justify-center gap-3 items-center flex-wrap"
        role="list"
          ...
          <div
            ...
            style={{
              ...
              background: s.highlight
                ? `linear-gradient(135deg, ${brand.primary}33, ${brand.secondary}22)`
