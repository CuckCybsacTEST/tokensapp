...
export function ReservationForm() {
  ...
  const [availabilityStatus, setAvailabilityStatus] = useState<
    "available" | "limited" | "unavailable" | null
  >(null);
      ...
      <div className="container mx-auto max-w-5xl px-4 md:px-8 relative z-10">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div
              className="mt-10 p-6 rounded-xl backdrop-blur-sm"
              style={{
            ...
            >
              ...
              <p style={{ color: brand.text.secondary }}>
                Miércoles a Domingo: 7:00 PM - 3:00 AM
                <br />
            ...
            >
              {!sent ? (
                <form onSubmit={onSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    {availabilityMessage && (
                      <p
                        ...
                        style={{
                          color:
                            availabilityStatus === "limited" ? brand.primary : brand.text.secondary,
                        }}
                      >
                  ...
                  {error && (
                    <p
                      className="text-sm text-center mt-3 p-2 rounded"
                      style={{
                        color: "#fff",
                ...
                >
                  ...
                  >
                    <div
                      className="inline-flex items-center gap-3 px-5 py-2 rounded-lg"
                      style={{
