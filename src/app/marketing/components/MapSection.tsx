...
export function MapSection() {
  ...
  const contactInfo = {
    ...
    schedule: [{ days: "Martes - Domingo", hours: "5:00 PM - 5:00 AM" }],
  };
    ...
    >
      ...
      <div data-map-inner className="container mx-auto max-w-7xl px-4 md:px-8 relative z-10 w-full">
          ...
          subtitle={
            <>
              <span className="hidden md:inline">
                Dirección, referencia y mapa para ubicarte rápido.
              </span>
              <span className="inline md:hidden text-sm">Dirección y mapa rápido.</span>
            </>
          }
        />
        <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
            ...
            <div className="space-y-6">
              <div>
                ...
                {contactInfo.reference && (
                  <p className="mt-1 text-sm" style={{ color: brand.text.tertiary }}>
                    Referencia: {contactInfo.reference}
                  </p>
                )}
                {/* Mapa móvil inline (debajo de dirección) */}
                <div className="mt-5 md:hidden">
                  <div
                    className="w-full h-60 rounded-xl overflow-hidden relative border"
                    style={{
                  ...
                  >
                    <div className="absolute inset-0">
                      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        ...
                        <p
                          className="text-center px-4 text-[11px] leading-snug"
                          style={{ color: brand.text.secondary }}
                        >
                          Pronto: mapa interactivo (Google / Mapbox).
                        </p>
                      </div>
                      <div
                        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-4 w-4 rounded-full animate-pulse"
                        style={{
                          background: brand.primary,
                          boxShadow: `0 0 0 4px ${brand.primary}55, 0 0 0 10px ${brand.primary}22`,
                        }}
                      />
                    </div>
                  </div>
          ...
          >
            <div
              className="w-full h-[380px] md:h-[420px] rounded-2xl overflow-hidden relative border"
            ...
            >
              ...
              <div className="absolute inset-0">
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  ...
                  <p
                    className="text-center px-6 text-xs md:text-sm max-w-md"
                    style={{ color: brand.text.secondary }}
                  >
                    Aquí irá el mapa interactivo. Usa un iframe de Google Maps (embed) o integra
                    Mapbox/Leaflet.
                  </p>
                </div>
                <div
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-5 w-5 rounded-full animate-pulse"
                  style={{
                    background: brand.primary,
                    boxShadow: `0 0 0 6px ${brand.primary}55, 0 0 0 14px ${brand.primary}22`,
                  }}
                />
              </div>
            </div>
