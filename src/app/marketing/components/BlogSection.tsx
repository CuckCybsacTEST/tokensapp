    ...
    >
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-8 pt-2 md:pt-6 pb-6 md:pb-10 relative z-10 w-full">
          ...
          subtitle={
            <>
              <span className="hidden md:inline">
                Mixología, tecnología nocturna y experiencias interactivas.
              </span>
              <span className="inline md:hidden text-sm">Mixología, tech y experiencias.</span>
            </>
          }
        />
        {/* Slider móvil */}
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              >
                ...
                <div
                  className="absolute top-2 left-2 rounded-full px-3 py-1 text-[10px] backdrop-blur-md"
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-[11px]" style={{ color: brand.text.secondary }}>
                    {post.read}
                  </span>
                  <span
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs" style={{ color: brand.text.secondary }}>
        ...
        <div className="mt-6 md:mt-10 text-center">
          <a
            href="#"
            className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-xs md:text-sm font-semibold"
            style={{
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3 min-w-0 flex-1">
              <strong className="text-[13px] md:text-sm tracking-tight whitespace-nowrap">
                Grupo WhatsApp
              </strong>
              <span
                className="text-[11px] md:text-xs opacity-70 truncate"
            ...
            <a
              ...
              style={{
                background: "#25D366",
                color: "#0B1C13",
                boxShadow: "0 4px 14px -6px rgba(37,211,102,0.55)",
              }}
