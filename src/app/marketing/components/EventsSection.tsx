...
export function EventsSection({ events }: EventsSectionProps) {
  return (
    <section id="eventos" className="relative py-14 md:py-20 overflow-hidden">
            ...
            {events.map((event) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col gap-2">
                  <span className="inline-block rounded-full text-xs px-2.5 py-1 backdrop-blur-md mb-1 self-start" 
                    style={{ 
                  ...
                  <div className="flex justify-between items-center mt-2 gap-2">
                    ...
                    <a href="/marketing/cumpleanos" className="rounded-full py-1 px-3 text-xs font-medium transition-all transform group-hover:scale-105" 
                      style={{ 
