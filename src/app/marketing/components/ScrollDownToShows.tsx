...
export function ScrollDownToShows({ className }: Props) {
  ...
  const baseCls = className ?? 'absolute bottom-10 z-[1100] flex items-center justify-center w-10 h-10 rounded-full bg-white shadow-md cursor-pointer hover:opacity-90 pointer-events-auto';
  ...
  return (
    <>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-6 h-6 text-gray-800">
