  ...
  const qrFeatures = [
    {
      title: "Tecnología QR",
      description:
        "Pulseras y mesas con QR para participar, votar, ganar rewards y desbloquear contenido en vivo.",
    },
    {
      title: "Sábados Estelares",
      description: "Nuestra noche insignia: headliners, shows temáticos y bloques especiales.",
    },
    {
      title: "Luces inteligentes",
      description: "Programación dinámica, escenas y sincronía para un ambiente envolvente.",
    },
    {
      title: "Experiencias inmersivas",
      description: "Efectos especiales (CO₂, confetti) y dinámicas que te meten en la acción.",
    },
    {
      title: "Cocteles de autor",
      description: "Recetas pensadas para cada momento del set, con presentaciones memorables.",
    },
    {
      title: "Artistas en escena",
      description: "Performers, hosts e invitados que suben la energía de la noche.",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-8 pt-2 md:pt-4 pb-4 md:pb-8 relative z-10 w-full">
          ...
          subtitle={
            <>
              <span className="hidden md:inline">
                Combinamos tecnología QR, shows y ambientación para crear una noche inmersiva:
                sábados estelares, luces inteligentes, experiencias inmersivas, cocteles de autor y
                artistas en escena.
              </span>
              <span className="inline md:hidden text-sm">
                Tecnología QR, shows y ambientación inmersiva.
              </span>
            </>
          }
        />
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-8 md:gap-10 items-center justify-center">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p
                          ...
                          style={{ color: brand.text.secondary, fontFamily: "var(--font-text)" }}
                        >
                          {feature.description}
                        </p>
                      </div>
          ...
          {!hideVisual && (
            ...
            >
              <div
                className="relative w-full max-w-md aspect-[4/5] rounded-2xl overflow-hidden border"
                style={{
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
                  <div
                    className="w-28 h-28 sm:w-32 sm:h-32 rounded-lg border-2 border-dashed flex items-center justify-center mb-4"
                  ...
                  <p
                    className="text-xs opacity-80 text-center max-w-xs"
                    style={{ color: brand.text.secondary }}
                  >
                    Todo parte de tu QR: participa, vota y gana. El entorno (luces, pantallas y
                    efectos) acompaña cada momento para que vivas la noche.
                  </p>
                  <a
                    href="#"
                    className="mt-4 rounded-md px-4 py-2 text-xs font-semibold inline-block"
                    style={{
                ...
                <div
                  ...
                  style={{ border: `1px solid ${brand.secondary}22` }}
                />
                <div
