...
export function TestimonialsSection({ testimonials }: TestimonialsSectionProps) {
  return (
    <section
      id="testimonios"
      className="py-14 md:py-20 relative overflow-hidden flex items-center justify-center"
    >
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="text-2xl mb-2 opacity-40 text-center" style={{ color: brand.accent }}>
                ❝
              </div>
