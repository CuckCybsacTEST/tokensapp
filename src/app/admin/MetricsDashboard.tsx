    ...
    <>
      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md border border-slate-100 dark:border-slate-700 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          />
          <StatCard
            label="Tokens Revelados"
            value={metrics.revealed}
            description={pct(metrics.revealed) + " del total"}
            color="text-violet-600"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-violet-500/80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
