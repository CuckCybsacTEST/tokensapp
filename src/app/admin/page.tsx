  ...
  <section className="grid grid-cols-1 gap-6">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300 mb-3 max-w-prose">
            Administra la base de datos de clientes, niveles de membresía, seguimiento de visitas y sistema de puntos.
          </p>
          <div className="flex flex-wrap gap-2">
            <a href="/admin/customers" className="btn">Clientes</a>
            <a href="/admin/customers/visits" className="btn">Registro de Visitas</a>
            <a href="/admin/customers/analytics" className="btn">Analytics</a>
          </div>
        </div>
