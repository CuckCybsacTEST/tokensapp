  ...
  {!entryRegistered && !exitRegistered && !pendingMode && (
        ...
        {entryRegistered && (
          <div className="rounded-md border border-emerald-300 dark:border-emerald-600 bg-emerald-50 dark:bg-emerald-900/20 p-4 space-y-3 animate-fadeIn shadow-sm">
            ...
            <div className="pt-2 flex gap-2">
              <a href={`/u/checklist?day=${encodeURIComponent(entryRegistered.businessDay || computeBusinessDayFromUtc(new Date(), getConfiguredCutoffHour()))}&mode=IN`} className="inline-flex flex-1 items-center justify-center rounded-md bg-emerald-600 hover:bg-emerald-500 dark:bg-emerald-700 dark:hover:bg-emerald-600 text-white text-sm font-medium px-4 py-2 shadow-sm">Ver lista de tareas</a>
        ...
        {exitRegistered && (
          <div className="rounded-md border border-indigo-300 dark:border-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 p-4 space-y-3 shadow-sm">
            ...
            <div className="pt-2">
              <a href={backHref} className="block w-full text-center px-4 py-2 rounded-md bg-indigo-600 hover:bg-indigo-500 dark:bg-indigo-700 dark:hover:bg-indigo-600 text-sm font-semibold text-white shadow focus:outline-none focus:ring-2 focus:ring-indigo-300 dark:focus:ring-indigo-600">Volver al panel</a>
            </div>
          </div>
        )}
        <div>
          <a href={backHref} className="text-blue-600 dark:text-blue-400 text-sm hover:underline">← Volver</a>
        </div>
      </div>
      <style jsx global>{`
