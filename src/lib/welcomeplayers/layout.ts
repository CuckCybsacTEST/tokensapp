...
export const WELCOME_PLAYERS_LAYOUT_PROFILES: Record<Exclude<WelcomePlayersDisplayMode, "auto">, WelcomePlayersLayoutProfile> = {
  kiosk: {
    shellClassName: "relative w-full bg-[#060816] text-white min-h-[100dvh] overflow-hidden rounded-none px-8 py-8",
    stageClassName: "relative mx-auto flex flex-col min-h-[calc(100dvh-4rem)] w-full max-w-none gap-6",
    headerClassName: "flex flex-col items-center text-center gap-6 pt-2",
    logoClassName: "h-20 w-auto object-contain opacity-95",
    titleClassName: "font-black leading-[0.9] tracking-[-0.05em] text-white text-[clamp(5rem,7vw,7.4rem)]",
    subtitleClassName: "mt-4 leading-relaxed text-white/88 text-[clamp(1.45rem,2vw,2rem)]",
    introClassName: "max-w-[56rem]",
    wheelStageClassName: "relative mx-auto flex w-full items-center justify-center max-w-none flex-1 py-3",
    wheelClassName: "relative flex aspect-square touch-manipulation items-center justify-center overflow-visible rounded-full border border-white/10 bg-[#0A0D16] outline-none select-none ring-1 ring-white/5 w-[min(82vw,68dvh,58rem)]",
    arrowClassName: "h-0 w-0 border-l-transparent border-r-transparent border-t-amber-300 drop-shadow-[0_6px_16px_rgba(0,0,0,0.28)] border-l-[28px] border-r-[28px] border-t-[46px]",
    actionButtonClassName: "w-full rounded-[1.65rem] border border-white/10 bg-gradient-to-r from-fuchsia-600 via-pink-500 to-amber-400 text-center font-black uppercase tracking-[0.24em] text-white shadow-[0_16px_32px_rgba(236,72,153,0.18)] transition-transform active:scale-[0.99] disabled:opacity-70 px-6 py-6 text-[1.35rem]",
    statsCardClassName: "rounded-[1.5rem] border border-white/10 bg-white/4 px-4 py-5 text-center backdrop-blur-sm",
    footerClassName: "text-center text-white/45 pb-2 pt-2 text-[1.1rem]",
    modalClassName: "relative z-[1] w-full rounded-[2rem] border border-white/10 bg-[#070A12] text-center shadow-[0_28px_80px_rgba(0,0,0,0.45)] max-w-2xl p-10",
    modalTitleClassName: "mt-3 font-black leading-none tracking-[-0.05em] text-white text-[clamp(3.5rem,5vw,5rem)]",
    modalCopyClassName: "mx-auto mt-4 leading-relaxed text-white/78 max-w-xl text-[1.35rem]",
    modalButtonClassName: "mt-6 w-full rounded-[1.15rem] border border-amber-300/30 bg-gradient-to-r from-fuchsia-600 via-rose-500 to-amber-400 font-black uppercase tracking-[0.24em] text-white shadow-[0_14px_28px_rgba(244,114,182,0.18)] transition-transform active:scale-[0.99] px-6 py-5 text-[1.1rem]",
  },
  compact: {
    ...
    wheelClassName: "relative flex aspect-square touch-manipulation items-center justify-center overflow-visible rounded-full border border-white/10 bg-[#0A0D16] outline-none select-none ring-1 ring-white/5 w-[min(72vw,46dvh,28rem)]",
  ...
  standard: {
    ...
    wheelClassName: "relative flex aspect-square touch-manipulation items-center justify-center overflow-visible rounded-full border border-white/10 bg-[#0A0D16] outline-none select-none ring-1 ring-white/5 w-[min(88vw,34rem)]",
    arrowClassName: "h-0 w-0 border-l-transparent border-r-transparent border-t-amber-300 drop-shadow-[0_6px_16px_rgba(0,0,0,0.28)] border-l-[18px] border-r-[18px] border-t-[30px]",
