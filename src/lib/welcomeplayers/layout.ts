...
export const WELCOME_PLAYERS_LAYOUT_PROFILES: Record<Exclude<WelcomePlayersDisplayMode, "auto">, WelcomePlayersLayoutProfile> = {
  kiosk: {
    shellClassName: "relative h-[100vh] w-full bg-[#060816] text-white min-h-[100vh] overflow-hidden rounded-none px-6 py-6",
  ...
  compact: {
    shellClassName: "relative w-full bg-[#060816] text-white min-h-[100vh] overflow-x-hidden overflow-y-visible rounded-[2rem] px-4 py-5",
    ...
    subtitleClassName: "mt-5 leading-relaxed text-white/88 text-[clamp(0.95rem,1.5vw,1.1rem)]",
    ...
    footerClassName: "text-center text-white/45 pb-1 pt-2 text-[0.8rem]",
  ...
  standard: {
    shellClassName: "relative w-full bg-[#060816] text-white min-h-[100vh] overflow-x-hidden overflow-y-visible rounded-[2rem] px-4 py-4",
